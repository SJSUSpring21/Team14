...
if __name__ == '__main__':
    ...
    # load customDataset
    metadata = np.load('faceData/metadata.npy',allow_pickle=True)

    # load embedded
    embedded = np.load('faceData/embedded.npy',allow_pickle=True)
    ...
    classifier.layers[0].weights = PrivateEncodedTensor.from_shares(
        np.load('weights/encrypted_layer0_weights_0.npy',allow_pickle=True),
        np.load('weights/encrypted_layer0_weights_1.npy',allow_pickle=True))
    classifier.layers[0].bias = PrivateEncodedTensor.from_shares(
        np.load('weights/encrypted_layer0_bias_0.npy',allow_pickle=True),
        np.load('weights/encrypted_layer0_bias_1.npy',allow_pickle=True))
